...
EXPORT int filter(double *x, double *P, const double *H, const double *v, const double *R, int n,
                  int m);
...
EXPORT int reppaths(const char *path, char *rpaths[], int nmax, gtime_t ts, gtime_t te,
...
EXPORT int iontec(gtime_t time, const nav_t *nav, const double *pos, const double *azel, int opt,
                  double *delay, double *var);
EXPORT void readtec(const char *file, nav_t *nav, int opt);
EXPORT int ionocorr(gtime_t time, const nav_t *nav, int sat, const double *pos, const double *azel,
                    int ionoopt, double *ion, double *var);
EXPORT int tropcorr(gtime_t time, const nav_t *nav, const double *pos, const double *azel,
...
EXPORT int peph2pos(gtime_t time, int sat, const nav_t *nav, int opt, double *rs, double *dts,
                    double *var);
EXPORT void satantoff(gtime_t time, const double *rs, int sat, const nav_t *nav, double *dant);
EXPORT int satpos(gtime_t time, gtime_t teph, int sat, int ephopt, const nav_t *nav, double *rs,
...
EXPORT int tle_pos(gtime_t time, const char *name, const char *satno, const char *desig,
...
EXPORT int decode_frame(const uint8_t *buff, int sys, eph_t *eph, alm_t *alm, double *ion,
                        double *utc);
...
EXPORT int readsolt(const char *files[], int nfile, gtime_t ts, gtime_t te, double tint, int qflag,
                    int mean, solbuf_t *sol);
EXPORT int readsolstat(const char *files[], int nfile, solstatbuf_t *statbuf);
EXPORT int readsolstatt(const char *files[], int nfile, gtime_t ts, gtime_t te, double tint,
...
EXPORT int convkml(const char *infile, const char *outfile, gtime_t ts, gtime_t te, double tint,
                   int qflg, int mean, const char *name, double *offset, int tcolor, int pcolor,
                   int outalt, int outtime);

/* gpx converter -------------------------------------------------------------*/
EXPORT int convgpx(const char *infile, const char *outfile, gtime_t ts, gtime_t te, double tint,
                   int qflg, int mean, const char *name, double *offset, int outtrk, int outpnt,
                   int outalt, int outtime);

// CSV converter -------------------------------------------------------------
EXPORT int convcsv(const char *infile, const char *outfile, gtime_t ts, gtime_t te, double tint,
                   int qflg, int mean, const char *name, double *offset, int outalt, int outtime,
                   int outorder);
...
EXPORT int sbssatcorr(gtime_t time, int sat, const nav_t *nav, double *rs, double *dts,
                      double *var);
EXPORT int sbsioncorr(gtime_t time, const nav_t *nav, const double *pos, const double *azel,
                      double *delay, double *var);
...
EXPORT int pntpos(const obsd_t *obs, int n, const nav_t *nav, const prcopt_t *opt, sol_t *sol,
...
EXPORT int strsvrstart(strsvr_t *svr, int *opts, int *strs, const char **paths, const char **logs,
                       strconv_t **conv, const char **cmds, const char **cmds_periodic,
...
EXPORT int rtksvrstart(rtksvr_t *svr, int cycle, int buffsize, int *strs, const char **paths,
                       int *formats, int navsel, const char **cmds, const char **cmds_periodic,
                       const char **rcvopts, int nmeacycle, int nmeareq, const double *nmeapos,
                       prcopt_t *prcopt, solopt_t *solopt, stream_t *moni, char *errmsg);
...
EXPORT int dl_exec(gtime_t ts, gtime_t te, double ti, int seqnos, int seqnoe, const url_t *urls,
                   ...
                   const char *pwd, const char *proxy, int opts, char *msg, FILE *fp);
