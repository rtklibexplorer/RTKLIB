...
static void warn_on_invalid_sol(rtk_t *rtk, const double *v, const double *R, const int *vflg,
                  int nv, double thres)
{
                  ...
                  const nav_t *nav)
{
    ...
    double *rs,*dts,*var,*y,*e,*azel,*freq,*v,*H,*R,*xa,*bias,dt;
    ...
    free(xa); free(v);   free(H);   free(R); free(bias);
