...
static int encode_type1019(rtcm_t *rtcm, int sync) {
  ...
  i += 1;
  setbitu(rtcm->buff, i, 1, eph->fit > 4 ? 1 : 0);
  i += 1;
  rtcm->nbit = i;
  return 1;
}
...
static int encode_type1044(rtcm_t *rtcm, int sync) {
  ...
  setbitu(rtcm->buff, i, 10, eph->iodc);
  i += 10;
  setbitu(rtcm->buff, i, 1, eph->fit > 2 ? 1 : 0);
  i += 1;
  rtcm->nbit = i;
  return 1;
}
...
static void gen_msm_index(const rtcm_t *rtcm, int sys, int *nsat, int *nsig, int *ncell,
                          uint8_t *sat_ind, uint8_t *sig_ind, uint8_t *cell_ind) {
...
static int encode_msm1(rtcm_t *rtcm, int sys, int sync) {
  ...
  /* encode msm header */
  if (!(i = encode_msm_head(1, rtcm, sys, sync, &nsat, &ncell, rrng, rrate, NULL, psrng, NULL, NULL,
                            NULL, NULL, NULL))) {
    return 0;
  }
...
static int encode_msm2(rtcm_t *rtcm, int sys, int sync) {
  ...
  /* encode msm header */
  if (!(i = encode_msm_head(2, rtcm, sys, sync, &nsat, &ncell, rrng, rrate, NULL, NULL, phrng, NULL,
                            lock, half, NULL))) {
    return 0;
  }
  /* encode msm satellite data */
...
static int encode_msm3(rtcm_t *rtcm, int sys, int sync) {
  ...
  /* encode msm header */
  if (!(i = encode_msm_head(3, rtcm, sys, sync, &nsat, &ncell, rrng, rrate, NULL, psrng, phrng,
                            NULL, lock, half, NULL))) {
    return 0;
  }
  /* encode msm satellite data */
...
static int encode_msm4(rtcm_t *rtcm, int sys, int sync) {
  ...
  /* encode msm header */
  if (!(i = encode_msm_head(4, rtcm, sys, sync, &nsat, &ncell, rrng, rrate, NULL, psrng, phrng,
                            NULL, lock, half, cnr))) {
    return 0;
  }
  /* encode msm satellite data */
...
static int encode_msm5(rtcm_t *rtcm, int sys, int sync) {
  ...
  /* encode msm header */
  if (!(i = encode_msm_head(5, rtcm, sys, sync, &nsat, &ncell, rrng, rrate, info, psrng, phrng,
                            rate, lock, half, cnr))) {
    return 0;
  }
  /* encode msm satellite data */
...
static int encode_msm6(rtcm_t *rtcm, int sys, int sync) {
  ...
  /* encode msm header */
  if (!(i = encode_msm_head(6, rtcm, sys, sync, &nsat, &ncell, rrng, rrate, NULL, psrng, phrng,
                            NULL, lock, half, cnr))) {
    return 0;
  }
  /* encode msm satellite data */
...
static int encode_msm7(rtcm_t *rtcm, int sys, int sync) {
  ...
  /* encode msm header */
  if (!(i = encode_msm_head(7, rtcm, sys, sync, &nsat, &ncell, rrng, rrate, info, psrng, phrng,
                            rate, lock, half, cnr))) {
    return 0;
  }
  /* encode msm satellite data */
