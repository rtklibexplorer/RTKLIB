...
static void decodetcppath(const char *path, char *addr, char *port, char *user, char *passwd,
                          char *mntpnt, char *str) {
...
/* decode ftp path -----------------------------------------------------------*/
static void decodeftppath(const char *path, char *addr, char *file, char *user, char *passwd,
                          int *topts) {
  char buff[MAXSTRPATH], *p, *q;
...
#endif
{
  ...
  if ((p = strrchr(local, '.')) && (!strcmp(p, ".z") || !strcmp(p, ".gz") || !strcmp(p, ".zip") ||
