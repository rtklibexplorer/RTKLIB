...
/* print tec grid data -------------------------------------------------------*/
static void printtec(int index, gtime_t time, double sec, const nav_t *nav, const double *rpos,
                     int nlat, int nlon, double dpos, FILE *fp) {
  int i, j;
