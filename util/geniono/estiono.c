...
static void init_iono(const obsd_t *obs, const double *azel, double *x, double *P, int nx) {
  double map, iono;
...
static void udstate(const obsd_t *obs, int n, const nav_t *nav, double *x, double *P, int nx,
                    ssat_t *ssat) {
  gtime_t time;
  double tt;
  int i, sat;
...
static void sat_azel(const obsd_t *obs, int n, const nav_t *nav, const double *pos, double *azel) {
...
static int res_iono(const obsd_t *obs, int n, const double *azel, const double *x, int nx,
...
static int out_iono(gtime_t time, const double *x, const double *P, int nx, FILE *fp) {
  double tow;
  char id[64];
  int i, week;
