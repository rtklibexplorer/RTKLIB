...
void utest2(void) {
  ...
  time2epoch(t, ep);
  assert(!s && ep[0] == 2004 && ep[1] == 1 && ep[2] == 1 && ep[3] == 0 && ep[4] == 1 &&
         fabs(ep[5] - 2.34) < 1E-15);
  ...
  time2epoch(t, ep);
  assert(!s && ep[0] == 1980 && ep[1] == 10 && ep[2] == 30 && ep[3] == 6 && ep[4] == 58 &&
         ep[5] == 9);
  s = str2time(s4, 4, 20, &t);
  time2epoch(t, ep);
  assert(!s && ep[0] == 2037 && ep[1] == 12 && ep[2] == 31 && ep[3] == 1 && ep[4] == 2 &&
         ep[5] == 3);
...
void utest3(void) {
  ...
  t = epoch2time(ep1);
  time2epoch(t, ep);
  assert(ep[0] == 2004 && ep[1] == 2 && ep[2] == 28 && ep[3] == 2 && ep[4] == 0 &&
...
void utest4(void) {
  ...
  time2epoch(t, ep);
  assert(ep[0] == 2006 && ep[1] == 11 && ep[2] == 11 && ep[3] == 23 && ep[4] == 59 &&
         ep[5] == 59.0);
...
void utest5(void) {
  ...
  time2epoch(t, ep);
  assert(ep[0] == 2003 && ep[1] == 12 && ep[2] == 31 && ep[3] == 23 && ep[4] == 59 &&
         ep[5] == 58.0);
...
void utest7(void) {
  ...
  time2epoch(t, ep);
  assert(ep[0] == 1992 && ep[1] == 6 && ep[2] == 30 && ep[3] == 23 && ep[4] == 59 &&
         fabs(ep[5] - 59.999999) < 1E-14);
  ...
  time2epoch(t, ep);
  assert(ep[0] == 2005 && ep[1] == 12 && ep[2] == 31 && ep[3] == 23 && ep[4] == 59 &&
         ep[5] == 47.0);
  t = gpst2utc(epoch2time(ep6));
  time2epoch(t, ep);
  assert(ep[0] == 2037 && ep[1] == 12 && ep[2] == 31 && ep[3] == 23 && ep[4] == 59 &&
         ep[5] == 42.0);
  printf("%s utset7 : OK\n", __FILE__);
}
/* utc2gpst(), gpst2utc() */
