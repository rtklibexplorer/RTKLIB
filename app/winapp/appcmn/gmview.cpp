...
//---------------------------------------------------------------------------
void __fastcall TGoogleMapView::AddMark(double lat, double lon, AnsiString title, AnsiString msg) {
  AnsiString f;
  if (lon >= 180.0) lon -= 360.0;
  ExecFunc(f.sprintf("AddMark(%.7f,%.7f,\"%s\",\"%s\")", lat, lon, title.c_str(), msg.c_str()));
}
//---------------------------------------------------------------------------
void __fastcall TGoogleMapView::PosMark(double lat, double lon, AnsiString title) {
  AnsiString f;
