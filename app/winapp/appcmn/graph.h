...
class TGraph  // graph class
{
 ...
 public:
  ...
  void DrawMark(TPoint p, int mark, TColor color, TColor bgcolor, int size, int rot);
  void DrawMark(double x, double y, int mark, TColor color, TColor bgcolor, int size, int rot);
  void DrawMarks(const double *x, const double *y, const TColor *color, int n, int mark, int size,
                 int rot);
  ...
  void DrawText(double x, double y, UTF8String str, TColor color, int ha, int va, int rot);
  void DrawText(double x, double y, UTF8String str, TColor color, int ha, int va, int rot,
                AnsiString font);
  void DrawText(TPoint p, UTF8String str, TColor color, int ha, int va, int rot);
  void DrawText(TPoint p, UTF8String str, TColor color, int ha, int va, int rot, AnsiString font);
  void DrawText(double x, double y, UTF8String str, TColor color, TColor bgcolor, int ha, int va,
                int rot);
  void DrawText(TPoint p, UTF8String str, TColor color, TColor bgcolor, int ha, int va, int rot);
  ...
  void DrawSkyPlot(double x, double y, TColor color1, TColor color2, TColor bgcolor, double size);
};
#endif
