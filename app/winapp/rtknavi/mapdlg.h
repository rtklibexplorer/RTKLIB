...
class TMapDialog : public TForm {
 ...
 private:
  ...
  void __fastcall DrawVertGraph(const double *sol, const int *stat, int psol, int psols, int psole,
                                int nsol, int currentstat);
  TPoint __fastcall PosToPoint(const double *pos);
  TPoint __fastcall PosToGraphP(const double *pos, const double *ref, int index, int npos,
                                TRect rect);
  ...
  void __fastcall DrawGrid(TPoint p, int gint, int ng, TColor color1, TColor color2);
 ...
 public:
  ...
  void __fastcall UpdateMap(const double *sol, const double *solref, const double *vel,
