...
class TMainForm : public TForm {
  ...
  void __fastcall Table1MouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
                                  int Y);
  void __fastcall Table2MouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
                                  int Y);
  void __fastcall Table0MouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
                                  int Y);
