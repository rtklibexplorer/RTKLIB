...
class TMapOptDialog : public TForm {
  ...
  void __fastcall ScaleXUpDownChangingEx(TObject *Sender, bool &AllowChange, int NewValue,
                                         TUpDownDirection Direction);
  void __fastcall LatUpDownChangingEx(TObject *Sender, bool &AllowChange, int NewValue,
                                      TUpDownDirection Direction);
  void __fastcall LonUpDownChangingEx(TObject *Sender, bool &AllowChange, int NewValue,
                                      TUpDownDirection Direction);
  void __fastcall BtnCloseClick(TObject *Sender);
  void __fastcall BtnUpdateClick(TObject *Sender);
  void __fastcall BtnSaveClick(TObject *Sender);
  void __fastcall ScaleYUpDownChangingEx(TObject *Sender, bool &AllowChange, int NewValue,
                                         TUpDownDirection Direction);
