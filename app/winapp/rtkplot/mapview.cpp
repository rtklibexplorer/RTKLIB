...
//---------------------------------------------------------------------------
void __fastcall TMapView::BtnZoomOutClick(TObject *Sender) { ExecFunc(MapSel, "ZoomOut()"); }
//---------------------------------------------------------------------------
void __fastcall TMapView::BtnZoomInClick(TObject *Sender) { ExecFunc(MapSel, "ZoomIn()"); }
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TMapView::AddMark(int map, int index, double lat, double lon, int state) {
  UTF8String func;
