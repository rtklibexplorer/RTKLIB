...
class TSkyImgDialog : public TForm {
  ...
  void __fastcall SkyScaleUpDownChangingEx(TObject *Sender, bool &AllowChange, int NewValue,
                                           TUpDownDirection Direction);
  void __fastcall SkyElMaskMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
                                   int Y);
  void __fastcall SkyDestCorrMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
                                     int Y);
  void __fastcall SkyFlipMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
                                 int Y);
  void __fastcall SkyResChange(TObject *Sender);
  void __fastcall BtnLoadClick(TObject *Sender);
  void __fastcall BtnGenMaskClick(TObject *Sender);
  void __fastcall SkyBinThres1UpDownChangingEx(TObject *Sender, bool &AllowChange, short NewValue,
                                               TUpDownDirection Direction);
  void __fastcall SkyBinThres2UpDownChangingEx(TObject *Sender, bool &AllowChange, short NewValue,
                                               TUpDownDirection Direction);
  void __fastcall SkyBinarizeMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift, int X,
                                     int Y);
