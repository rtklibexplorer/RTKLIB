...
//---------------------------------------------------------------------------
__fastcall TPlotOptDialog::TPlotOptDialog(TComponent *Owner) : TForm(Owner) { FontOpt = new TFont; }
//---------------------------------------------------------------------------
...
void __fastcall TPlotOptDialog::BtnOKClick(TObject *Sender) {
  ...
  Plot->NavSys = (NavSys1->Checked ? SYS_GPS : 0) | (NavSys2->Checked ? SYS_GLO : 0) |
...
//---------------------------------------------------------------------------
void __fastcall TPlotOptDialog::AutoScaleChange(TObject *Sender) { UpdateEnable(); }
//---------------------------------------------------------------------------
void __fastcall TPlotOptDialog::OriginChange(TObject *Sender) { UpdateEnable(); }
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TPlotOptDialog::RcvPosChange(TObject *Sender) { UpdateEnable(); }
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TPlotOptDialog::ChkTimeSyncClick(TObject *Sender) { UpdateEnable(); }
//---------------------------------------------------------------------------
