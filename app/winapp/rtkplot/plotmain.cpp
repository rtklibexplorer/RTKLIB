...
void __fastcall TPlot::MenuMapViewClick(TObject *Sender) {
  ...
  MapView->Caption = s.sprintf("%s-%s %s: Map View", PRGNAME, VER_RTKLIB, PATCH_LEVEL);
  MapView->Show();
}
...
void __fastcall TPlot::UpdateEnable(void) {
  ...
  SatList->Visible = PlotType == PLOT_RES || PlotType == PLOT_RESE || PlotType >= PLOT_OBS ||
                     PlotType == PLOT_SSKY || PlotType == PLOT_SKY || PlotType == PLOT_SDOP ||
  ...
  BtnFitHoriz->Visible = PlotType == PLOT_SOLP || PlotType == PLOT_SOLV || PlotType == PLOT_SOLA ||
                         ...
                         PlotType == PLOT_DOP || PlotType == PLOT_SDOP || PlotType == PLOT_SNR ||
                         PlotType == PLOT_SNRE;
  ...
  BtnFixHoriz->Visible = PlotType == PLOT_SOLP || PlotType == PLOT_SOLV || PlotType == PLOT_SOLA ||
                         PlotType == PLOT_NSAT || PlotType == PLOT_RES || PlotType == PLOT_OBS ||
                         PlotType == PLOT_DOP || PlotType == PLOT_DOP || PlotType == PLOT_SNR;
  ...
  BtnShowImg->Visible =
      PlotType == PLOT_TRK || PlotType == PLOT_SKY || PlotType == PLOT_SSKY || PlotType == PLOT_MPS;
